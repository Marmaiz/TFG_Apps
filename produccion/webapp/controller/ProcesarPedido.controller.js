...
], (Controller, UIComponent, MessageToast, MessageBox, Filter, FilterOperator) => {
  "use strict";

  return Controller.extend("produccion.controller.ProcesarPedido", {
    onInit: function () {
    ...
    _onRouteMatched: function (oEvent) {
      ...
      oView.bindElement({
        ...
        parameters: { expand: "Cliente,Lineas" },
        events: {
            dataReceived: () => {
                
                const oTable = this.byId("tablaTrazabilidad"); // PONLE ID A LA TABLA
                const oBinding = oTable.getBinding("rows");
                
                const oFilter = new Filter({
                    path: "Linea/Pedido/Id",
    ...
    onAsignarEntrada: function (oEvent) {
      ...
      if (!this._oDialogAsignarEntrada) {
        this._oDialogAsignarEntrada = sap.ui.xmlfragment(
          "produccion.view.AsignarEntrada",
          this
        );
